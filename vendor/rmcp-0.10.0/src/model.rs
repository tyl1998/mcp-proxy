...
impl ProtocolVersion {
    ...
    /// MRTR（multi-round tool results）协议版本（补丁新增，见 README.patch.md）
...
pub struct CallToolRequestParam {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub arguments: Option<JsonObject>,
    /// Protocol-level metadata for this request (e.g. inputResponses for
    /// multi-round tool results, MCP 2025-06-18+). Patched in from upstream
    /// rmcp 0.11+ where the field exists natively.
    #[serde(rename = "_meta", default, skip_serializing_if = "Option::is_none")]
    pub meta: Option<Meta>,
}

impl CallToolRequestParam {
